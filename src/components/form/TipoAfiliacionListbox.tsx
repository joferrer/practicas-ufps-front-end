...
import useTipoAfiliacionEps from '../../hooks/useTipoAfiliacion';
...
export const TipoAfiliacionListbox: FC<TipoAfiliacionListboxProps> = ({ value = '', onChange }) => {
  const { tipoAfiliacionEps } = useTipoAfiliacionEps();
  ...
  return (
    <>
      <Listbox value={value} onChange={onChange}>
        ...
        >
          { value 
            ? tipoAfiliacionEps.find((i) => i.id == value)?.nombre  
        ...
        >
          ...
          >
            {
              tipoAfiliacionEps.map((tipoAfiliacion) => (
                <ListboxOption
                  key={tipoAfiliacion.id}
                  value={tipoAfiliacion.id}
